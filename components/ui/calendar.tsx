...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-popover group/calendar p-4 [--cell-size:2.75rem] rounded-md [background-color:hsl(var(--color-popover))]",
      ...
      classNames={{
        ...
        nav: cn(
          "absolute inset-x-0 top-0 flex w-full items-center justify-between gap-2 mb-2",
        ...
        weekday: cn(
          "text-muted-foreground flex-1 select-none rounded-md text-sm font-medium pb-2",
